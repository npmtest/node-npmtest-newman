...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-newman/node_modules/newman/lib/run/options.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-newman/node_modules/newman/lib/run/options.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-newman/node_modules/newman/lib/run/</a> &#187; options.js</div>
</div>
<div class="body">
...
&nbsp;
     ...
     */
    extractModel = <span class="fstat-no" title="function not covered" >function (source, type) {</span>
<span class="cstat-no" title="statement not covered" >        source = source[type] || source; </span>// extract object that holds variable. these usually come from cloud API
<span class="cstat-no" title="statement not covered" >        if (!_.isObject(source)) {</span>
<span class="cstat-no" title="statement not covered" >            return undefined;</span>
        }
&nbsp;
        // ensure we un-box the JSON if it comes from cloud-api or similar sources
<span class="cstat-no" title="statement not covered" >        !source.values &amp;&amp; _.isObject(source[type]) &amp;&amp; (source = source[type]);</span>
&nbsp;
...
&nbsp;
     ...
     * @returns {*}
     */
    externalLoader = <span class="fstat-no" title="function not covered" >function (type, location, cb) {</span>
<span class="cstat-no" title="statement not covered" >        return _.isString(location) ? util.fetchJson(location, <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (err) {</span>
<span class="cstat-no" title="statement not covered" >                return cb(err);</span>
            }
<span class="cstat-no" title="statement not covered" >            return cb(null, extractModel(data, type));</span>
...
&nbsp;
     ...
     * @returns {*|Function} -
     */
    processCollection = <span class="fstat-no" title="function not covered" >function (collection, callback) {</span>
<span class="cstat-no" title="statement not covered" >        return transformer.isv1(collection) ? transformer.convert(collection, COLLECTION_TRANSFORMER_OPTION, callback) :</span>
...
&nbsp;
     ...
     */
    loadScopes = <span class="fstat-no" title="function not covered" >function (type, value, callback) {</span>
<span class="cstat-no" title="statement not covered" >        var done = <span class="fstat-no" title="function not covered" >function (err, scope) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_.isObject(scope)) {</span>
<span class="cstat-no" title="statement not covered" >                return done(new Error(LOAD_ERROR_MESSAGE + type));</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            callback(null, new VariableScope(VariableScope.isVariableScope(scope) ? scope.toJSON() : scope));</span>
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_.isObject(value)) {</span>
<span class="cstat-no" title="statement not covered" >            return done(null, value);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        externalLoader(type, value, done);</span>
    },
&nbsp;
    /**
...
&nbsp;
         ...
         * @return {*}
         */
        collection: <span class="fstat-no" title="function not covered" >function (value, callback) {</span>
&nbsp;
            /**
             ...
             * @returns {*}
             */
<span class="cstat-no" title="statement not covered" >            var done = <span class="fstat-no" title="function not covered" >function (err, collection) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (err) {</span>
<span class="cstat-no" title="statement not covered" >                    return callback(err);</span>
                }
&nbsp;
                // ensure that the collection option is present before starting a run
<span class="cstat-no" title="statement not covered" >                if (!_.isObject(collection)) {</span>
<span class="cstat-no" title="statement not covered" >                    return callback(new Error(COLLECTION_LOAD_ERROR_MESSAGE));</span>
                }
&nbsp;
                // ensure that the collection reference is an SDK instance
                // @todo - should this be handled by config loaders?
<span class="cstat-no" title="statement not covered" >                collection = new Collection(Collection.isCollection(collection) ?</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                callback(null, collection);</span>
            };
&nbsp;
            // if the collection has been specified as an object, convert to V2 if necessary and return the result
<span class="cstat-no" title="statement not covered" >            if (_.isObject(value)) {</span>
<span class="cstat-no" title="statement not covered" >                return processCollection(value, done);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            externalLoader('collection', value, <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (err) {</span>
...
<span class="cstat-no" title="statement not covered" >                    return done(new Error(COLLECTION_LOAD_ERROR_MESSAGE));</span>
                }
<span class="cstat-no" title="statement not covered" >                return processCollection(data, done);</span>
            });
        },
&nbsp;
        /**
...
&nbsp;
         ...
         * @returns {*}
         */
        iterationData: <span class="fstat-no" title="function not covered" >function (location, callback) {</span>
<span class="cstat-no" title="statement not covered" >            if (_.isArray(location)) { <span class="cstat-no" title="statement not covered" >return callback(null, location); </span>}</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            util.fetch(location, <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (err) {</span>
<span class="cstat-no" title="statement not covered" >                    return callback(err);</span>
                }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                            return cb(null, parseJson(data));</span>
                        }
                        catch (e) {
<span class="cstat-no" title="statement not covered" >                            return cb(null, undefined); </span>// e masked to avoid displaying JSON parse errors for CSV files
                        }
                    },
                    (json, cb) =&gt; {
...
<span class="cstat-no" title="statement not covered" >                            return cb(null, json);</span>
                        ...
                        // Wasn't JSON
<span class="cstat-no" title="statement not covered" >                        parseCsv(data, { columns: true, escape: '\\' }, cb);</span>
                    }
                ], (err, parsed) =&gt; {
<span class="cstat-no" title="statement not covered" >                    if (err) {</span>
...
<span class="cstat-no" title="statement not covered" >    config.get(options, { loaders: configLoaders, command: 'run' }, callback);</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
